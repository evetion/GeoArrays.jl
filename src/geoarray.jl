...
Base.getindex(ga::GeoArray, I::Vararg{Union{Int, Vararg{<:AbstractRange{<:Int}} }, 2}) = getindex(ga.A, I..., :)
Base.getindex(ga::GeoArray, I::Vararg{Union{Int, Vararg{<:AbstractRange{<:Int}} }, 3} ) = getindex(ga.A, I...)
